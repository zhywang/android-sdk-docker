...
RUN dpkg --add-architecture i386 && \
    apt-get update && \
    apt-get install -y git wget unzip libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses5 lib32z1 openjdk-8-jdk-headless && \
    apt-get clean
...
RUN echo y | android-sdk-linux/tools/bin/sdkmanager --sdk_root=/opt/android-sdk-linux \
             "platform-tools" \
